                          ...
                          <div className="col-span-1 bg-white border border-gray-300 h-80 overflow-auto">
                            <div className="card">
                              <ul className="list-group">
                                <li className="list-group-item bg-dark mt-3" aria-current="true"><h5>Total 10 of Vehicle</h5></li>
                                <li className="list-group-item bg-dark mt-3" aria-current="true"><h5>Total 10 of Owners </h5></li>
                                <li className="list-group-item bg-dark mt-3" aria-current="true"><h5>Total 10 of Users </h5></li>
                                <li className="list-group-item bg-dark mt-3" aria-current="true"><h5>Total 10 of Notifications </h5></li>
                              </ul>
                            </div>
                            </div>
                          </>
                      ...
                      <div className="card">
                        ...
                        >
                          ...
                          <div>
                            ...
                            adipisicing elit. Nobis, omnis! Vero laudantium
                            dicta obcaecati praesentium, voluptas nisi excepturi
                            alias ducimus quaerat eius corrupti ut tempore,
                            dolores placeat libero voluptate odio.
                          </div>
                        ...
                        <div
                          className="col-sm-11 ml-4 me-2 first bg-dark text-light mt-3"
                          data-toggle="collapse"
                        ...
                        <div
                          className="alert rul cus_pad text-justify collapse "
                          role="alert"
