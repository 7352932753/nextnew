    ...
    const handleSubmit = async () => {
        ...
        const q3 = await query(
          ...
          const unsubscribe3 =await onSnapshot(q3, (querySnapshot) => {
            ...
            // setVehicle_color(itemsArrnew[0].vehicle_color);
            // setVehicle_id(itemsArrnew[0].vehicle_id);
            // setVehiclename(itemsArrnew[0].name);
            // setImageUrl(itemsArrnew[0].vehicle_image_url);
            // setVehicleno(itemsArrnew[0].vehicle_no);
            ...
            <div className="container-fluid">
              <div className="row mb-2">
                <div className="col-sm-6">
                  <h1 className="m-0"> Assign Vehicle To Owner</h1>
                </div>
                ...
                <div className="col-sm-6">
                  <ol className="breadcrumb float-sm-right">
                    ...
                    <li className="breadcrumb-item active">Assign Vehicle To Owner </li>
                  </ol>
                </div>
              </div>
            </div>
            ...
            <div className="col-md-8">
              <div className="card card-dark">
                <div className="card-header">
                  <h3 className="card-title">Assign Vehicle To Owner </h3>
                </div>
