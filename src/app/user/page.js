...
export default function Page() {
  ...
  const handleShow = async (id) => {
   ...
   setImgurl("");
    ...
    const q =  query(collection(firestoreDb, "user"),where("userId", "==", uid));
  ...
  const deleteItem = async (id,email,password) => {
    setLoading(true)
    ...
    // await deleteDoc(doc(firestoreDb, `/user/${id}/assign_vehicle`));
    // await deleteDoc(doc(firestoreDb, `/user/${id}/favourite`));
    // await deleteDoc(doc(firestoreDb, `/user/${id}/history`));
        ...
        {loading2 ?  <div className="loading"></div>  : <span></span>}
          <div className="row">
              <div className="col-6 form-group">
                ...
                <input type="text" className="form-control" id="name" name="name" value={name} aria-describedby="emailHelp" placeholder="Enter Name"/>
              </div>
              <div className=" col-6 form-group">
                <label htmlFor="exampleInputEmail1">Email address</label>
                <input type="text" className="form-control" id="name" readOnly  defaultValue={email} aria-describedby="emailHelp" placeholder="Enter Name"/>
              </div>
              <div className=" col-6 form-group">
              ...
              <div className=" col-6 form-group">
                ...
                <input type="text" className="form-control" id="name" defaultValue={city} onChange={(e)=> setCity(e.target.value)} placeholder="City"/>
              </div>
              <div className=" col-6 form-group">
                <label htmlFor="exampleInputEmail1">State</label>
                <input type="text" className="form-control" id="name" defaultValue={state} onChange={(e)=> setState(e.target.value)} placeholder="State"/>
              </div>
              <div className=" col-6 form-group">
                <label htmlFor="exampleInputEmail1">Zip Code</label>
                <input type="text" className="form-control" id="name" defaultValue={zip}  onChange={(e)=> setZip(e.target.value)} placeholder="ZIp Code"/>
              </div>
              <div className=" col-6 form-group">
                <label htmlFor="exampleInputEmail1">Country</label>
                <input type="text" className="form-control" id="name" defaultValue={country} onChange={(e)=> setCountry(e.target.value)} placeholder="Country"/>
              </div>
              <div className=" col-6 form-group">
              ...
              <div className=" col-6 form-group">
                <label htmlFor="exampleInputEmail1">Old Image</label>
                 <Link href={imgurl} target="_blank"> <Image className="form-control" src={imgurl} style={{width:"200px",height:"100px"}} /> </Link>
              </div>
            ...
            <div className="container-fluid">
              <div className="row mb-2">
                <div className="col-sm-3">
                  <h1 className="m-0">
                    Users &nbsp; &nbsp;{" "}
                    <Link className="btn btn-dark" href="/user/adduser.html">Add User</Link>
                    {/* <Link className="btn btn-dark" href={{pathname: '/about',
                    query:{
                      name: 'Raushan Kumar',
                      age: '21'
                    }
                ...
                <tbody>
                  {records.map((item, id) => (
                    <tr key={item.id}>
                      ...
                      <td>
                        <button
                          onClick={() => deleteItem(item.id,item.email,item.password)}
